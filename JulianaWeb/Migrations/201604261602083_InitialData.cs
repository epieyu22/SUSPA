    ...
    public partial class InitialData : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ApplicationGroup", t => t.GroupId, cascadeDelete: true)
                .Index(t => t.RoleId)
                .Index(t => t.GroupId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationUserGroups", "GroupId", "dbo.ApplicationGroup");
            DropForeignKey("dbo.AspNetUserRoles", "IdentityRole_Id", "dbo.AspNetRoles");
            DropForeignKey("dbo.ApplicationRoleGroups", "GroupId", "dbo.ApplicationGroup");
            ...
            DropTable("dbo.ApplicationGroup");
        }
    }
}
